...
\vspace{0.3em} 
$48/\displaystyle{\binom{52}{5}} \approx 0.00002$
\end{block}
...
\end{block}
\vspace{0.3em} 
\only<2->{$624/\displaystyle{\binom{52}{5}} \approx 0.00024$}
...
\begin{figure}
\centering
\begin{tikzpicture}[thick,scale=0.7, every node/.style={transform shape},grow'=left]
\node {Winner} 
...
\begin{figure}
\fbox{\includegraphics[scale = 0.69]{./images/gaga}}
\hspace{1em}
\fbox{\includegraphics[scale = 0.69]{./images/obama}}
\end{figure}
\begin{enumerate}
	\item Gaga/Gaga
	\item Obama/Gaga
...
\begin{tikzpicture}[thick,scale=0.85, every node/.style={transform shape},grow=right]
\node[bag]{Choose Card}
    child {
